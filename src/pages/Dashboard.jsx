  ...
  return (
    <div className="space-y-6 animate-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
        <StatCard label="Total Exceptions" value={data.total_exceptions} icon={AlertTriangle} color="text-brand" />
        <StatCard label="Open Exceptions" value={data.open_exceptions} icon={Zap} color="text-blue-400" />
        <StatCard label="Critical Exceptions" value={data.critical_exceptions} icon={TrendingDown} color="text-red-400" />
